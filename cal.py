...
class CUB_200_2011_Test(Dataset):
    ...
    def __init__(self, path, transform=None, target_transform=None):
        ...
        self.root = '/root/SharedData/datasets/CUB_200_2011'
        self.transform = transform
        self.target_transform = target_transform
        self.images_path = {}
        with open(os.path.join(self.root, 'images.txt')) as f:
...
train = CUB_200_2011_Train('/root/SharedData/datasets/CUB_200_2011')
test = CUB_200_2011_Test('/root/SharedData/datasets/CUB_200_2011')
compute_mean_and_std(train)
compute_mean_and_std(test)